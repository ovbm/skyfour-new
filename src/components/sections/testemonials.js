          ...
          <Slider style={{ marginBottom: '1.5em' }}>
            <SSlide index={0}>
              <Testemonial>
                ...
                eure Musik war grosse Klasse. Die Gäste waren begeistert. Vielen
                Dank!
              </Testemonial>
            ...
            <SSlide index={1}>
              <Testemonial>
                ...
                super toll gemacht! Wir haben rundum Komplimente wegen der Band
                erhalten, denn nicht nur der Gesang und die Musik waren
            ...
            <SSlide index={2}>
              <Testemonial>
                Wir möchten Euch ein grosses Kompliment machen und uns bei euch
                herzlich für die musikalische Begleitung unserer Hochzeit
            ...
            <SSlide index={4}>
              <Testemonial>
                ...
                Skyfour. Die Musik war toll, genau so wie wir es uns vorgestellt
                hatten: Eine coole Jazz Band die im Hintergrund Atmosphäre
                macht. Wir werden euch gerne weiterempfehlen.
              </Testemonial>
            ...
            <SSlide index={5}>
              <Testemonial>
                ...
                bekamen viele schöne Feedbacks von unseren Gästen. Die Band war
                einfach der HAMMER. Schön seit ihr dabei gewesen.
              </Testemonial>
